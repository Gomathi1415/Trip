...
class ExploreFragment : Fragment(), RecyclerAdapterListener {
    ...
    var backgroundMainText =
        arrayOf("Best Tourist Destination", "Explore your hotels", "Find best restaurants", "Travel Map")
    var backgroundSubText = arrayOf(
        "Discover amazing tourist places",
        "Discover Cheapest and most Convenien hotels around you",
        "Explore your taste Buds",
        "Convenient and easy to use Travel Map of tour destination"
    )
    var userPreference = arrayOf("Hotel", "Things to do", "Restaurant")
    var userPreferenceImage =
        intArrayOf(R.drawable.hotel_icon, R.drawable.things_to_do_icon, R.drawable.restaurant_icon)
